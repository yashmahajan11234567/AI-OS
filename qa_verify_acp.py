#!/usr/bin/env python3
"""QA verification script - NOT a test, just runtime evidence gathering."""
import asyncio, os, tempfile, textwrap, sys
from pathlib import Path

# Ensure we use the repo src
...
# Reset singleton so fresh construction is allowed
...
''')
        ...
        try:
            ...
            print(f"VERIFY: new_session() returned ID len = {len(session_id)}")
            ...
            print(f"VERIFY: prompt() has text = {'text' in prompt_result}")
