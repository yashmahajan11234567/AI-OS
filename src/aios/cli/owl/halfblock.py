"""
AI-OS Owl Half-Block Rasterizer.
...
class PaletteColors:
    ...
    accent_teal_fg: str = "\x1b[38;2;0;191;166m"   # #00BFA6
    accent_teal_bg: str = "\x1b[48;2;0;191;166m"
...
def render_fallback(state: str, frame_index: int = 0) -> str:
    ...
    return "\n".join(frames[frame_index % len(frames)])
...
def render_state(state: str, frame_index: int = 0, mode: RenderMode = RenderMode.FULL) -> str:
    ...
    if mode == RenderMode.JSON:
        frame = OwlAssets.get_frame(state, frame_index)
