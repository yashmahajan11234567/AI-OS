...
class EventType(str, Enum):
    ...
    PROVIDER_COOLDOWN_STARTED = "PROVIDER_COOLDOWN_STARTED"
    PROVIDER_COOLDOWN_EXPIRED = "PROVIDER_COOLDOWN_EXPIRED"
    ...
    MCP_SERVER_VALIDATION_FAILED = "MCP_SERVER_VALIDATION_FAILED"
    MCP_TOOL_DISCOVERED = "MCP_TOOL_DISCOVERED"
    MODEL_ROUTED = "MODEL_ROUTED"
    MODEL_FALLBACK = "MODEL_FALLBACK"
    MODEL_PROVIDER_REGISTERED = "MODEL_PROVIDER_REGISTERED"
    PROVIDER_GROUP_SELECTED = "PROVIDER_GROUP_SELECTED"
    MEMORY_GRAPHIFY_QUERY = "MEMORY_GRAPHIFY_QUERY"
    MEMORY_GRAPHIFY_PATH = "MEMORY_GRAPHIFY_PATH"
    AGENT_REACH_FETCH = "AGENT_REACH_FETCH"
    AGENT_REACH_NORMALIZED = "AGENT_REACH_NORMALIZED"
    HERMES_BRIDGE_TASK = "HERMES_BRIDGE_TASK"
    HERMES_BRIDGE_OBSERVATION = "HERMES_BRIDGE_OBSERVATION"
    PROMPT_TEMPLATE_RENDERED = "PROMPT_TEMPLATE_RENDERED"
    TOKEN_BUDGET_EXCEEDED = "TOKEN_BUDGET_EXCEEDED"
    PERSONA_OVERRIDE_APPLIED = "PERSONA_OVERRIDE_APPLIED"
    FAILURE_CLASSIFIED = "FAILURE_CLASSIFIED"

    # === INTEGRATION (External Ecosystem Onboarding) ===
    INTEGRATION_STATUS_CHANGED = "INTEGRATION_STATUS_CHANGED"

    # === M13 SELF-LOOP & SELF-PROMPTING (Autonomous Decision Engine) ===
    SELF_LOOP_CYCLE_STARTED = "SELF_LOOP_CYCLE_STARTED"
    SELF_LOOP_CYCLE_COMPLETED = "SELF_LOOP_CYCLE_COMPLETED"
    SELF_LOOP_CYCLE_FAILED = "SELF_LOOP_CYCLE_FAILED"
    SELF_LOOP_PHASE_STARTED = "SELF_LOOP_PHASE_STARTED"
    SELF_LOOP_PHASE_COMPLETED = "SELF_LOOP_PHASE_COMPLETED"
    SELF_LOOP_PHASE_FAILED = "SELF_LOOP_PHASE_FAILED"
    SELF_LOOP_PAUSED = "SELF_LOOP_PAUSED"
    SELF_LOOP_PAUSED_FOR_APPROVAL = "SELF_LOOP_PAUSED_FOR_APPROVAL"
    SELF_LOOP_RESUMED = "SELF_LOOP_RESUMED"
    SELF_LOOP_STOPPED = "SELF_LOOP_STOPPED"

    # === M13 SELF-PROMPT LIFECYCLE ===
    SELF_PROMPT_GENERATED = "SELF_PROMPT_GENERATED"
    SELF_PROMPT_VALIDATED = "SELF_PROMPT_VALIDATED"
    SELF_PROMPT_REJECTED = "SELF_PROMPT_REJECTED"
    SELF_PROMPT_EXPIRED = "SELF_PROMPT_EXPIRED"

    # === M13 BOUNDED EXECUTION ===
    BOUNDED_EXECUTION_STARTED = "BOUNDED_EXECUTION_STARTED"
    BOUNDED_EXECUTION_COMPLETED = "BOUNDED_EXECUTION_COMPLETED"
    BOUNDED_EXECUTION_FAILED = "BOUNDED_EXECUTION_FAILED"
    BOUNDED_EXECUTION_RETRY = "BOUNDED_EXECUTION_RETRY"

    # === M13 EXTERNAL INTEGRATION CONTROL ===
    EXTERNAL_INTEGRATION_REQUESTED = "EXTERNAL_INTEGRATION_REQUESTED"
    EXTERNAL_INTEGRATION_RESPONDED = "EXTERNAL_INTEGRATION_RESPONDED"
    EXTERNAL_INTEGRATION_FAILED = "EXTERNAL_INTEGRATION_FAILED"
    EXTERNAL_INTEGRATION_DEGRADED = "EXTERNAL_INTEGRATION_DEGRADED"

    # === M13 DASHBOARD ===
    DASHBOARD_ACTION_REQUESTED = "DASHBOARD_ACTION_REQUESTED"
    DASHBOARD_ACTION_AUTHORIZED = "DASHBOARD_ACTION_AUTHORIZED"
    DASHBOARD_ACTION_REJECTED = "DASHBOARD_ACTION_REJECTED"
    DASHBOARD_ACTION_COMPLETED = "DASHBOARD_ACTION_COMPLETED"

    # === M13 FAILURE RECOVERY ===
    FAILURE_DETECTED = "FAILURE_DETECTED"
    FAILURE_CLASSIFIED_M13 = "FAILURE_CLASSIFIED_M13"
    RECOVERY_INITIATED = "RECOVERY_INITIATED"
    RECOVERY_COMPLETED = "RECOVERY_COMPLETED"
    RECOVERY_FAILED = "RECOVERY_FAILED"
    RECOVERY_ESCALATED = "RECOVERY_ESCALATED"

    # === M13 PROVENANCE & LEARNING ===
    PROVENANCE_RECORDED = "PROVENANCE_RECORDED"
    PROVENANCE_VALIDATED = "PROVENANCE_VALIDATED"
    PROVENANCE_CHAIN_EXTENDED = "PROVENANCE_CHAIN_EXTENDED"
