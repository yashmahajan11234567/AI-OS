...
_EVENT_TYPE_CATEGORY: dict[EventType, EventCategory] = {
    ...
    EventType.FAILURE_CLASSIFIED: EventCategory.CONTROL,
    # === INTEGRATION ===
    EventType.INTEGRATION_STATUS_CHANGED: EventCategory.DIAGNOSTIC,
    # === M13 SELF-LOOP & SELF-PROMPTING ===
    EventType.SELF_LOOP_CYCLE_STARTED: EventCategory.SYSTEM,
    EventType.SELF_LOOP_CYCLE_COMPLETED: EventCategory.SYSTEM,
    EventType.SELF_LOOP_CYCLE_FAILED: EventCategory.SYSTEM,
    EventType.SELF_LOOP_PHASE_STARTED: EventCategory.SYSTEM,
    ...
    EventType.SELF_PROMPT_VALIDATED: EventCategory.AUDIT,
    EventType.SELF_PROMPT_REJECTED: EventCategory.AUDIT,
    EventType.SELF_PROMPT_EXPIRED: EventCategory.AUDIT,
    EventType.BOUNDED_EXECUTION_STARTED: EventCategory.CONTROL,
    EventType.BOUNDED_EXECUTION_COMPLETED: EventCategory.CONTROL,
    EventType.BOUNDED_EXECUTION_FAILED: EventCategory.CONTROL,
    EventType.BOUNDED_EXECUTION_RETRY: EventCategory.CONTROL,
    EventType.EXTERNAL_INTEGRATION_REQUESTED: EventCategory.CONTROL,
    EventType.EXTERNAL_INTEGRATION_RESPONDED: EventCategory.CONTROL,
    EventType.EXTERNAL_INTEGRATION_FAILED: EventCategory.CONTROL,
    EventType.EXTERNAL_INTEGRATION_DEGRADED: EventCategory.CONTROL,
    EventType.DASHBOARD_ACTION_REQUESTED: EventCategory.AUDIT,
    EventType.DASHBOARD_ACTION_AUTHORIZED: EventCategory.AUDIT,
    EventType.DASHBOARD_ACTION_REJECTED: EventCategory.AUDIT,
    EventType.DASHBOARD_ACTION_COMPLETED: EventCategory.AUDIT,
    EventType.FAILURE_DETECTED: EventCategory.CONTROL,
    EventType.FAILURE_CLASSIFIED_M13: EventCategory.CONTROL,
    EventType.RECOVERY_INITIATED: EventCategory.CONTROL,
    EventType.RECOVERY_COMPLETED: EventCategory.CONTROL,
    EventType.RECOVERY_FAILED: EventCategory.CONTROL,
    EventType.RECOVERY_ESCALATED: EventCategory.CONTROL,
    EventType.PROVENANCE_RECORDED: EventCategory.AUDIT,
    EventType.PROVENANCE_VALIDATED: EventCategory.AUDIT,
    EventType.PROVENANCE_CHAIN_EXTENDED: EventCategory.AUDIT,
    EventType.LEARNING_EXTRACTED: EventCategory.AUDIT,
