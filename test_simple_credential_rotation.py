#!/usr/bin/env python3
"""
Simple test to verify credential rotation flow works.
"""
...
async def test_simple_credential_rotation():
    """Test the credential rotation flow."""
    print("Testing credential rotation flow...")
    ...
    try:
        ...
        print(f"✓ ConfigurationManager initialized and frozen")
        ...
        # Verify the new credential would be used
        ...
        # Verify ConfigurationManager reports the new secret
        ...
        print("\n🎉 ALL TESTS PASSED - CREDENTIAL ROTATION FLOW IS WORKING!")
        return True
...
if __name__ == "__main__":
    success = asyncio.run(test_simple_credential_rotation())
