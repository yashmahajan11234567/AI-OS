...
# M12 onboarding adds INTEGRATION_STATUS_CHANGED: total 133.
# M13 SELF-LOOP & SELF-PROMPTING adds 25 event types: total 158.
# Additional types beyond spec (FAILURE_CLASSIFIED_M13, etc.): total 171.
# M14 B4 evaluation lifecycle adds 3 event types: total 174.
CANONICAL_ORDER = [
    # SYSTEM
    ...
    "SELF_LOOP_CYCLE_STARTED",
    "SELF_LOOP_CYCLE_COMPLETED",
    "SELF_LOOP_CYCLE_FAILED",
    "SELF_LOOP_PHASE_STARTED",
    "SELF_LOOP_PHASE_COMPLETED",
    "SELF_LOOP_PHASE_FAILED",
    "SELF_LOOP_PAUSED",
    "SELF_LOOP_PAUSED_FOR_APPROVAL",
    "SELF_LOOP_RESUMED",
    "SELF_LOOP_STOPPED",
    # === M13 SELF-PROMPT LIFECYCLE ===
    "SELF_PROMPT_GENERATED",
    "SELF_PROMPT_VALIDATED",
    "SELF_PROMPT_REJECTED",
    "SELF_PROMPT_EXPIRED",
    # === M13 BOUNDED EXECUTION ===
    "BOUNDED_EXECUTION_STARTED",
    "BOUNDED_EXECUTION_COMPLETED",
    "BOUNDED_EXECUTION_FAILED",
    "BOUNDED_EXECUTION_RETRY",
    # === M13 EXTERNAL INTEGRATION CONTROL ===
    "EXTERNAL_INTEGRATION_REQUESTED",
    "EXTERNAL_INTEGRATION_RESPONDED",
    "EXTERNAL_INTEGRATION_FAILED",
    "EXTERNAL_INTEGRATION_DEGRADED",
    # === M13 DASHBOARD ===
...
EXPECTED_COUNT = 180
PROSE_COUNT = 97  # Part 2 §2.3.1 prose states 97; the enumeration originally contained 121; M5 adds 11 = 132; M12 onboarding adds 1 = 133; M13 adds 25 = 158; B3-T2 adds 3 (PLAN_AWAITING_APPROVAL, PLAN_APPROVED, SELF_LOOP_PAUSED_FOR_APPROVAL) = 161; additional types = 177; M14-B4 adds 3 (EVIDENCE_CREATED, VERIFICATION_PASSED, VERIFICATION_FAILED) = 180.
