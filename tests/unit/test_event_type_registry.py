...
CANONICAL_NAMES = [
    ...
    "MCP_TOOL_CALLED", "MCP_TOOL_SUCCEEDED", "MCP_TOOL_FAILED",
    "MCP_SERVER_DISCONNECTED", "MCP_SERVER_CONNECTED", "MCP_SERVER_VALIDATION_FAILED",
    "MCP_TOOL_DISCOVERED", "MODEL_ROUTED", "MODEL_FALLBACK", "MODEL_PROVIDER_REGISTERED",
    "MEMORY_GRAPHIFY_QUERY", "MEMORY_GRAPHIFY_PATH", "AGENT_REACH_FETCH",
    "AGENT_REACH_NORMALIZED", "HERMES_BRIDGE_TASK", "HERMES_BRIDGE_OBSERVATION",
    "PROMPT_TEMPLATE_RENDERED", "TOKEN_BUDGET_EXCEEDED", "PERSONA_OVERRIDE_APPLIED",
    "FAILURE_CLASSIFIED",
    ...
    "SELF_LOOP_CYCLE_STARTED", "SELF_LOOP_CYCLE_COMPLETED", "SELF_LOOP_CYCLE_FAILED",
    "SELF_LOOP_PHASE_STARTED", "SELF_LOOP_PHASE_COMPLETED", "SELF_LOOP_PHASE_FAILED",
    "SELF_LOOP_PAUSED", "SELF_LOOP_RESUMED", "SELF_LOOP_STOPPED",
    # === M13 SELF-PROMPT LIFECYCLE ===
    "SELF_PROMPT_GENERATED", "SELF_PROMPT_VALIDATED", "SELF_PROMPT_REJECTED",
    "SELF_PROMPT_EXPIRED",
    # === M13 BOUNDED EXECUTION ===
    "BOUNDED_EXECUTION_STARTED", "BOUNDED_EXECUTION_COMPLETED", "BOUNDED_EXECUTION_FAILED",
    "BOUNDED_EXECUTION_RETRY",
    # === M13 EXTERNAL INTEGRATION CONTROL ===
    "EXTERNAL_INTEGRATION_REQUESTED", "EXTERNAL_INTEGRATION_RESPONDED",
    "EXTERNAL_INTEGRATION_FAILED", "EXTERNAL_INTEGRATION_DEGRADED",
    # === M13 DASHBOARD ===
    "DASHBOARD_ACTION_REQUESTED", "DASHBOARD_ACTION_AUTHORIZED", "DASHBOARD_ACTION_REJECTED",
    "DASHBOARD_ACTION_COMPLETED",
    # === M13 FAILURE RECOVERY ===
    "FAILURE_DETECTED", "FAILURE_CLASSIFIED_M13", "RECOVERY_INITIATED", "RECOVERY_COMPLETED",
    "RECOVERY_FAILED", "RECOVERY_ESCALATED",
    # === M13 PROVENANCE & LEARNING ===
    "PROVENANCE_RECORDED", "PROVENANCE_VALIDATED", "PROVENANCE_CHAIN_EXTENDED",
    "LEARNING_EXTRACTED", "LEARNING_APPLIED", "LEARNING_REJECTED", "KNOWLEDGE_UPDATED",
]

EXPECTED_CANONICAL_COUNT = 171
