...
# Import the same modules as the test
...
async def main():
    ...
    # Create kernel without starting it first (to match test fixture)
    ...
    try:
        ...
        # Wait a bit more for async event processing (RootCauseAnalyzer -> event emission)
        print("Waiting for async event processing...")
        await asyncio.sleep(2.0)

        # Drain event bus again to catch any newly emitted events
        print("Draining event bus again...")
        await event_bus.drain()
        print("Event bus drained again")
        ...
        # =====================================================================
        print("Waiting for RootCauseAnalyzer to process events...")
