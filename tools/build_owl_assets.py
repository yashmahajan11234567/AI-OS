...
ACCENT_COLORS = {
    ...
    (0xFF, 0x33, 0x44),  # #FF3344 - red (executing - ACCENT only!)
...
OUTPUT_MODULE = Path("src/aios/cli/owl/assets.py")
...
def classify_pixel(r: int, g: int, b: int, a: int) -> int:
    ...
    # For strictness, we reject unknown colors
    # But for robustness during development, we can warn and classify
    closest = None
    min_dist = float('inf')
...
def main():
    ...
    print("=" * 60)
    print("AI-OS Owl Asset Build Tool")
    print("=" * 60)
